...
func TestPlugin_Test_ValidCredentials(t *testing.T) {
	...
	result := p.Test(ctx, "localhost:8086", "admin", "password", 5*time.Second)
...
func TestPlugin_Test_InvalidCredentials(t *testing.T) {
	...
	result := p.Test(ctx, "localhost:8086", "admin", "wrongpassword", 5*time.Second)
...
func TestPlugin_Test_ConnectionError(t *testing.T) {
	...
	result := p.Test(ctx, "invalid-host:8086", "admin", "password", 2*time.Second)
...
func TestPlugin_Test_Timeout(t *testing.T) {
	...
	result := p.Test(ctx, "192.0.2.1:8086", "admin", "password", 1*time.Second)
